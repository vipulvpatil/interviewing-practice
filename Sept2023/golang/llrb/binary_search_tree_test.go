...
func Test_BST(t *testing.T) {
	...
	t.Run("search", func(t *testing.T) {
		var b = constructRandomBST()
		expected := LLRBTreeNode[string, string]{key: "AA", value: "AA"}
		actual := b.Search("AA")
	...
	t.Run("min", func(t *testing.T) {
		var b = constructRandomBST()
		expected := LLRBTreeNode[string, string]{key: "A", value: "A"}
		actual := b.Min()
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
	})
	...
	t.Run("max", func(t *testing.T) {
		var b = constructRandomBST()
		expected := LLRBTreeNode[string, string]{key: "ZZZZZZZZZZZ", value: "ZZZZZZZZZZZ"}
		actual := b.Max()
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
	})
	...
	t.Run("floor", func(t *testing.T) {
		var b = constructRandomBST()
		expected := LLRBTreeNode[string, string]{key: "GG", value: "GG"}
		actual := b.Floor("GGA")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
		expected = LLRBTreeNode[string, string]{key: "FFFFFFFFFFF", value: "FFFFFFFFFFF"}
		actual = b.Floor("FGA")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
		expected = LLRBTreeNode[string, string]{key: "HHH", value: "HHH"}
		actual = b.Floor("HHH")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
	})
	...
	t.Run("ceil", func(t *testing.T) {
		var b = constructRandomBST()
		expected := LLRBTreeNode[string, string]{key: "H", value: "H"}
		actual := b.Ceil("GGH")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
		expected = LLRBTreeNode[string, string]{key: "KK", value: "KK"}
		actual = b.Ceil("KAL")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
		expected = LLRBTreeNode[string, string]{key: "MM", value: "MM"}
		actual = b.Ceil("MM")
		assert.Equal(t, expected.key, actual.key)
		assert.Equal(t, expected.value, actual.value)
	})
...
func constructExpectedBST() []*LLRBTreeNode[string, string] {
	return []*LLRBTreeNode[string, string]{
		{key: "A", value: "A"},
		{key: "AA", value: "AA"},
		{key: "AAA", value: "AAA"},
		{key: "AAAA", value: "AAAA"},
...
func constructRandomBST() *LLRBBinarySearchTree[string, string] {
